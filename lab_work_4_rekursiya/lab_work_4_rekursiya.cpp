...
int main() {
	...
	std::cout << "Функция, которая выводит числа от 1 до n" << std::endl;
	int number_1 = 1; 
	...
	std::cout << "Функция, которая выводит слово YES, если число n является точной степенью двойки, ";
	std::cout << "или слово NO в противном случае" << std::endl;
	...
	std::cout << "Функция, которая выводит заданное число Фибоначчи" << std::endl;
	...
	std::cout << "Функция, которая выводит сумму цифр числа" << std::endl;
	...
	std::cout << "Функция, которая выводит максимальное значение из последовательности чисел" << std::endl;
